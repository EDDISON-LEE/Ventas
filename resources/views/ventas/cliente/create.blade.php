    ...
    <div class="row">
        ...
        <div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		  <div class="form-group">
				...
				<input type="text" name="direccion" value="{{old('direccion')}}" class="form-control" placeholder="Direcciòn...">
		  </div>
		</div>
        ...
        <div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		  <div class="form-group">
				...
				<input type="text" name="email"  value="{{old('email')}}" class="form-control" placeholder="Dirección de Email...">
		  </div>
		</div>
